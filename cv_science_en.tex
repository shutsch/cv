...
\item[\textcolor{Green}{$\bullet$}]{\textbf{The Galactic velocity field} \,\textit{(active)} \newline \textit{Gas flow is a fundamental physical property of the ISM. Knowing it is to know the past and future path of the gas in the Galaxy, measure momentum, and infer the external forces acting on the star-forming gas. As a part of the ISM flow project, I am working on 3D reconstruction of the gas and velocity field in the local ISM.}}
